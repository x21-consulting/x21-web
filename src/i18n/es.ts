...
export const es: SiteContent = {
  ...
  contact: {
    ...
    crisis: {
      ...
      now: 'Ahora mismo',
      note: 'Llama o escribe y hablas con una persona, no con una centralita. O déjanos tus datos y te llamamos de inmediato.',
    ...
    articles: [
      {
        ...
        summary: 'Por qué la IA se ha convertido en un riesgo reputacional de primer nivel y qué revela al respecto la información que publican las empresas del S&P 500.',
        date: 'Enero de 2025',
